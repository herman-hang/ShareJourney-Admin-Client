      ...
      <el-form :model="smsForm" :rules="smsFormRules" ref="smsFormRef" label-width="110px">
        <el-tabs v-model="activeName" tab-position="left">
          ...
          <el-tab-pane label="ThinkAPI短信模板" name="think_sms_config">
            ...
            <el-form-item label="提现审核通过模板ID" prop="withdraw_pass_id"><el-input placeholder="请输入提现审核通过模板ID" v-model="smsForm.withdraw_pass_id"></el-input></el-form-item>
            <el-form-item label="提现审核驳回模板ID" prop="withdraw_reject_id"><el-input placeholder="请输入提现审核驳回模板ID" v-model="smsForm.withdraw_reject_id"></el-input></el-form-item>
            <el-form-item label="车主审核通过模板ID" prop="owner_pass_id"><el-input placeholder="请输入车主审核通过模板ID" v-model="smsForm.owner_pass_id"></el-input></el-form-item>
            <el-form-item label="车主审核驳回模板ID" prop="owner_reject_id"><el-input placeholder="请输入车主审核驳回模板ID" v-model="smsForm.owner_reject_id"></el-input></el-form-item>
            <!-- 提交按钮 -->
            <el-form-item><el-button type="primary" icon="el-icon-edit" @click="submit">提交</el-button></el-form-item>
          </el-tab-pane>
